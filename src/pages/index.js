        ...
        <div className="font-serif flex flex-col lg:flex-row">
              ...
              <div className="flex flex-row space-x-5">
                ...
                */}
                <a href="https://www.linkedin.com/in/nate-levine-/">
                  <div className="group p-3 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#fbf1c7,8px_8px_0_#22190e] duration-200">
                ...
                */}
                <a href="https://github.com/nate-levine">
                  <div className="group p-2 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md hover:stroke-black hover:stroke-[3] shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#fbf1c7,8px_8px_0_#22190e] duration-200">
          ...
          <div className="py-20 flex-1">
            <div className="w-[85%] mx-auto">
              ...
              <Link to="/articles">
                <div className="font-sans text-xl m-auto text-center w-[240px] mt-10 p-3 shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#fbf1c7,8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary hover:bg-black hover:text-primary duration-200">
