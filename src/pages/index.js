    ...
    <Layout>
      <div className="h-auto min-h-[100vh] text-black">
        <div className="font-serif flex flex-col lg:flex-row">
          <div className="py-20 flex-1 border-dashed border-b-2 lg:border-b-0 lg:border-r-2 border-black text-2xl bg-[url('../images/IMG_7455.png')] bg-bottom bg-[position:0%_166vw] md:bg-[position:0%_22.5vw] bg-contain md:bg-cover bg-no-repeat">
              ...
              <div className="flex flex-row space-x-5">
                ...
                */}
                <a href="https://www.linkedin.com/in/nate-levine-/">
                  <div className="group p-3 bg-primary hover:bg-black border-solid border-black border-2 rounded-md shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-2px_#fbf1c7,8px_8px_0_#22190e] duration-100">
                ...
                */}
                <a href="https://github.com/nate-levine">
                  <div className="group p-2 bg-primary hover:bg-black border-solid border-black border-2 rounded-md hover:stroke-black hover:stroke-[3] shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-2px_#fbf1c7,8px_8px_0_#22190e] duration-100">
          ...
          {/* Articles */}
          <div className="py-20 flex-1 bg-[url('../images/IMG_7456.png')] bg-bottom bg-[position:0%_300vw] md:bg-[position:0%_21vw]  bg-contain md:bg-cover bg-no-repeat">
            <div className="w-[80%] mx-auto">
              <ArticleView grid_config={"md:columns-2 lg:columns-2 gap-6"} filterFunc={isFeatured} />
              <Link to="/articles">
                <div className="font-sans text-xl m-auto text-center w-[240px] mt-10 p-3 shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-2px_#fbf1c7,8px_8px_0_#22190e] border-solid border-2 border-black rounded-md bg-primary hover:bg-black hover:text-primary duration-100">
