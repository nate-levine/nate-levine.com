                            ...
                            <div className="py-20 w-[85%] sm:w-[640px] mx-auto leading-relaxed">
                                ...
                                <div className="flex flex-row space-x-5">
                                    ...
                                    */}
                                    ...
                                    <div className="group p-3 hover:bg-black border-solid border-black border-[1px] rounded-md shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#fbf1c7,8px_8px_0_#22190e] duration-100">
                                    ...
                                    */}
                                    <a href="https://github.com/nate-levine">
                                        <div className="group p-2 hover:bg-black border-solid border-black border-[1px] rounded-md hover:stroke-black hover:stroke-[3] shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#fbf1c7,8px_8px_0_#22190e] duration-100">
