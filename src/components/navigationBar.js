...
const NavigationBar = () => {
    ...
    const toggleMenu = (e) => {
        ...
        menuButton.classList.toggle('shadow-[8px_8px_0_-2px_#ffeacf,8px_8px_0_black]')
    ...
    return (
        <nav className="flex justify-between items-center w-[90%] mx-auto font-sans font-bold text-xl text-black pt-0 pb-20 md:pb-0">
            <div className="font-bold z-30">
                <Link to="/">
                    <div className="nate-levine group relative text-4xl font-serif">
                        <div className="flex flex-col -space-y-3 justify-left text-right text-black">
                            <div>Nate</div>
                            <div>Levine</div>
                        </div>
                        <div className="grid grid-cols-4 absolute w-full aspect-square">
                            <div className="static block w-full h-0 group-hover:h-[25%] duration-[75ms] bg-red flex items-center justify-center">
                                <span className="opacity-0 group-hover:opacity-100 duration-[75ms] text-primary">.</span>
                            </div>
                            <div className="static block w-full h-0 group-hover:h-[25%] duration-[150ms] bg-green flex items-center justify-center">
                                <span className="opacity-0 group-hover:opacity-100 duration-[75ms] text-primary">d</span>
                            </div>
                            <div className="static block w-full h-0 group-hover:h-[25%] duration-[225ms] bg-yellow flex items-center justify-center">
                                <span className="opacity-0 group-hover:opacity-100 duration-[75ms] text-primary">e</span>
                            </div>
                            <div className="static block w-full h-0 group-hover:h-[25%] duration-[300ms] bg-blue flex items-center justify-center">
                ...
                <ul className="pt-6 pb-10 md:py-0 flex flex-col md:flex-row gap-5 w-[90%] justify-center">
                    <li className="w-full">
                        <Link to="/about" onClick={toggleMenu}>
                            <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary hover:bg-black hover:text-primary duration-0">About</div>
                        </Link>
                    </li>
                    <li className="w-full">
                        <Link to="/articles" onClick={toggleMenu}>
                            <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary hover:bg-black hover:text-primary duration-0">Articles</div>
                        </Link>
                    </li>
                    { <li className="w-full">
                        <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary duration-0 opacity-[50%]">Newsletter</div>
                    </li> }
                    <li>
                        {/*
                            LinkedIn Logo
                        ...
                        */}
                        <a href="https://www.linkedin.com/in/nate-levine-/">
                            <div className="group p-2 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] duration-0">
                    ...
                    <li>
                        ...
                        */}
                        <a href="https://github.com/nate-levine">
                            <div className="group p-1 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md hover:stroke-black hover:stroke-[3] shadow-[8px_8px_0_#22190e] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] duration-0">
            ...
            <div className="flex items-center gap-[6%] z-20">
                ...
                :
                // Open "X" icon
                <button className="menu-button shadow-[8px_8px_0_-2px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black p-2 rounded-md bg-black md:invisible md:w-[8.5vw] duration-0" onClick={toggleMenu}>
