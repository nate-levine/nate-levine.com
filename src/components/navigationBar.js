    ...
    return (
        <nav className="flex justify-between items-center w-[90%] mx-auto font-sans font-bold text-xl text-black pt-0 pb-20 md:pb-0">
                ...
                <ul className="pt-6 pb-10 md:py-0 flex flex-col md:flex-row gap-5 w-[90%] justify-center">
                    <li className="w-full">
                        <Link to="/about" onClick={toggleMenu}>
                            <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e,8px_8px_0_1px_#ffeacf] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary hover:bg-black hover:text-primary hover:border-primary duration-0">About</div>
                        </Link>
                    </li>
                    <li className="w-full">
                        <Link to="/articles" onClick={toggleMenu}>
                            <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e,8px_8px_0_1px_#ffeacf] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black rounded-md bg-primary hover:bg-black hover:text-primary hover:border-primary duration-0">Articles</div>
                        </Link>
                    </li>
                    { <li className="w-full">
                        <div className="w-full md:w-auto p-3 shadow-[8px_8px_0_#22190e,8px_8px_0_1px_#ffeacf] border-solid border-[1px] border-black rounded-md bg-primary duration-0 opacity-[50%]">Newsletter</div>
                    </li> }
                    <li>
                        {/*
                            LinkedIn Logo
                        ...
                        */}
                        <a href="https://www.linkedin.com/in/nate-levine-/">
                            <div className="group p-2 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md shadow-[8px_8px_0_#22190e,8px_8px_0_1px_#ffeacf] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] hover:border-primary duration-0">
                    ...
                    <li>
                        ...
                        */}
                        <a href="https://github.com/nate-levine">
                            <div className="group p-1 bg-primary hover:bg-black border-solid border-black border-[1px] rounded-md hover:stroke-black hover:stroke-[3] shadow-[8px_8px_0_#22190e,8px_8px_0_1px_#ffeacf] hover:shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] hover:border-primary duration-0">
            ...
            <div className="flex items-center gap-[6%] z-20">
                ...
                ?
                // Closed menu icon
                <button className="menu-button shadow-[8px_8px_0_-1px_#22190e,8px_8px_0_#ffeacf] border-solid border-[1px] border-black p-2 rounded-md bg-primary md:invisible md:w-[8.5vw] duration-0" onClick={toggleMenu}>
                ...
                :
                // Open "X" icon
                <button className="menu-button shadow-[8px_8px_0_-1px_#ffeacf,8px_8px_0_#22190e] border-solid border-[1px] border-black p-2 rounded-md bg-black md:invisible md:w-[8.5vw] duration-0" onClick={toggleMenu}>
