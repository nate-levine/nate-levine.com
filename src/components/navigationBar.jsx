...
const NavigationBar = () => {
    ...
    return (
        <nav class="flex justify-between items-center w-[92%] mx-auto">
            ...
            <div class="navigation-links md:static absolute md:min-h-fit min-h-[10vh] top-[4%] md:w-auto w-[100%] flex items-center justify-center bg-[#ebdbb2] left-0 left-[-100%]">
