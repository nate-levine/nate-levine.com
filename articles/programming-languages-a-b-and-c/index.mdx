...
<Components.Section title="Key Takeaways">
    <Components.UnorderedList>
        ...
        <Components.ListItem>Often, compiled/interpreted, statically/dynamically typed, and functional/object-oriented programming languages do not exist as most sit on a spectrum between these hard definitions.</Components.ListItem>
