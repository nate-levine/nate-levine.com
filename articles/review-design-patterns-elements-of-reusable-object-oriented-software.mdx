...
<Components.Title>What I Won't Talk About</Components.Title>
...
<Components.Title>A Time Before Java</Components.Title>
...
<Components.Title>Why Design Patterns are Important</Components.Title>
...
<Components.Title>The Two Principles of Object Oriented Design</Components.Title>
...
<Components.SubTitle>Program to an interface, not an implementation</Components.SubTitle>
...
<Components.SubTitle>Favor object composition over class inheritance</Components.SubTitle>
...
<Components.Title>Things to Think About</Components.Title>
