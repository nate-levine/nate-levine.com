...
<Components.Section title="Dislikes">
    ...
    <Components.BlockQuote>
        While I still believe that programming languages should be designed to be readable, my opinions about Racket have changed significantly after taking the University of Washington Seattle’s Programming Languages course. You can read my updated thoughts on Racket in <Components.InternalLink to="/articles/perhaps-i-was-too-hard-on-racket">Perhaps I Was Too Hard on Racket (Bonus Segment)</Components.InternalLink>
    </Components.BlockQuote>
