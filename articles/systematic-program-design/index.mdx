...
<Components.Section title="Dislikes">
    ...
    <Components.BlockQuote>While I still believe that programming languages design should prioritize readability, my opinions about Racket have changed significantly after taking the <Components.InternalLink to="/articles/programming-languages-a-b-and-c/">University of Washington Seattle’s Programming Languages</Components.InternalLink>  course. You can read my updated thoughts on Racket in <Components.InternalLink to="/articles/perhaps-i-was-too-hard-on-racket">Perhaps I Was Too Hard on Racket (Bonus Segment)</Components.InternalLink></Components.BlockQuote>
