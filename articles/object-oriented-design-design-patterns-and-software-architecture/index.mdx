...
<Components.Section title="Retrospective">
    <Components.Paragraph><Components.ExternalLink to="https://www.coursera.org/learn/object-oriented-design">Object-Oriented Design</Components.ExternalLink>, <Components.ExternalLink to="https://www.coursera.org/learn/design-patterns">Design Patterns</Components.ExternalLink>, and <Components.ExternalLink to="https://www.coursera.org/learn/software-architecture">Software Architecture</Components.ExternalLink> are the first three parts of a four-part collaborative course between Coursera and the University of Alberta. This course has many qualities that just don’t work in my opinion, leading to a result that is mild at best. I really, *really* tried to find good qualities of this course, but by the end I just couldn't.</Components.Paragraph>
