---
title: "Selling Blender Assets for Fun and Profit: Part 1"
date: "2025-03-31"
slug: "selling-blender-assets-for-fun-and-profit-part-1"
tags:
    - FEATURED
    - Project
    - Business
...
<Components.Section title="Preface">
    <Components.Paragraph>Originally, this project was going to be contained in a single post. However, I found myself with too many things to say and not enough space to tell them in one sitting. So instead, this post will be the first part of a multi-part series covering creating and selling Blender assets. Here is what you can (most likely) expect from each article:</Components.Paragraph>

    <Components.OrderedList>
        <Components.ListItem>Introduction to Blender assets</Components.ListItem>
        <Components.ListItem>Idea generation and market research</Components.ListItem>
        <Components.ListItem>Blender asset creation</Components.ListItem>
        <Components.ListItem>Marketing Blender assets and digital storefronts</Components.ListItem>
        <Components.ListItem>Retrospective on selling Blender assets</Components.ListItem>
    </Components.OrderedList>

    <Components.Paragraph>The goal of this series is to document my process for, reflect on my experience, and provide a helpful guide to selling Blender assets.</Components.Paragraph>
</Components.Section>

<Components.Section title="What is Blender?">
    <Components.Paragraph>Blender is an open-source 3D software used for 3D modeling, shading, animation, simulating, rigging, rendering, and compositing, among other uses.</Components.Paragraph>
</Components.Section>

<Components.Section title="Why Sell 3D Assets?">
    <Components.Paragraph>In the summer of 2023, I was looking to leverage my Blender skills as a side hustle to make some extra money. I was introduced to selling Blender assets through the YouTube channel “Hubert Knoblauch”. Hubert’s channel focuses on selling asset kits that allow users to build realistic 3D environments more easily in Blender. His Digital Set Dressing product markets to users looking to add realism to, or “set dress”, 3D urban environments through what is essentially digital kit bashing.</Components.Paragraph>
